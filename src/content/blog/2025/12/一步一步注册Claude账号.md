...
这时候需要输入一个手机号，我使用虚拟号码

第四步，**获取号码**

打开 
::btn[Hero-SMS]{link="(https://hero-sms.com/?ref=384850)"}
...
其实难点可能在于使用的IP质量，可以从ipdata那里查一下，最好是使用家宽，如果IP质量太差没办法触发系统发送短信，就跟文章前面这位朋友一样，试了很多平台都收不到手机验证码，需要家宽IP的可以查看我以往的文章